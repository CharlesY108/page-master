    ...
    <div class="main-content">
      ...
      <aside class="sidebar">
        <div class="menu-item1 active">
          <div><img src="../assets/index7.png" alt="" class="menu-img"/></div>
          <div>首页</div>
        </div>
        <div class="menu-item1">
          <div><img src="../assets/index8.png" alt="" class="menu-img"/></div>
          <div>质量结果</div>
        </div>
        <div class="menu-item1">
          <div><img src="../assets/index9.png" alt="" class="menu-img"/></div>
          <div>流程控制</div>
        </div>
        <div class="menu-item1">
          <div><img src="../assets/index10.png" alt="" class="menu-img"/></div>
          <div>智能分析</div>
        </div>
        <div class="menu-item1">
          <div><img src="../assets/index11.png" alt="" class="menu-img"/></div>
          <div>标准规范</div>
        </div>
        <div class="menu-item1">
          <div><img src="../assets/index12.png" alt="" class="menu-img"/></div>
          <div>要素指标</div>
        </div>
      </aside>
